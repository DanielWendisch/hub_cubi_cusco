...
plot_specs <- tribble(
  ...
  "RNA",    100,   basic_cluster_name,  " clusters (0.8)",                                             NULL,          "background corrected counts (cellbender)",
  ...
  "uncorrected_RNA",    200,   uncorrected_cluster_name,  " clusters (0.8)",                                             NULL,          "background uncorrected counts",
...
dataset_content <- "Alveolar and Intestinal Organoids"
