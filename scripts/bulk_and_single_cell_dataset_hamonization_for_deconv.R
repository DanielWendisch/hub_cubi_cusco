...
combined_bulk <- combined_bulk |>  select(-gene,-X) #leave only counts and enembl id
...
sce |> write_rds(paste0("intermediate_data/" , "single_cell_experiment", "RNA", "counts" ,dataset_name,".rds"  ))
bulk_mtx |> write_rds(paste0("intermediate_data/" , "bulk_mtx", "RNA", "counts" ,dataset_name,".rds"  ))
